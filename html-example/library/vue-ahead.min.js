var vueahead = (function (exports, axios) {
	'use strict';
	...
	__vue_render__$4._withStripped = true;
	  ...
	  var __vue_inject_styles__$4 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-6c0e7f99_0", { source: "\n.menu_option[data-v-6c0e7f99] {\r\n  background-color: transparent;\r\n  color: inherit;\r\n  cursor: default;\r\n  display: block;\r\n  font-size: inherit;\r\n  width: 100%;\r\n  user-select: none;\r\n  box-sizing: border-box;\r\n  padding: 6px 12px;\n}\n.menu_option.menu_option_active[data-v-6c0e7f99] {\r\n  background-color: rgb(222, 235, 255);\n}\r\n", map: {"version":3,"sources":["F:\\GitHub\\react-ahead\\vue-ahead\\src\\components\\dropdownItem.vue"],"names":[],"mappings":";AA6CA;EACA,6BAAA;EACA,cAAA;EACA,eAAA;EACA,cAAA;EACA,kBAAA;EACA,WAAA;EACA,iBAAA;EACA,sBAAA;EACA,iBAAA;AACA;AAEA;EACA,oCAAA;AACA","file":"dropdownItem.vue","sourcesContent":["<template>\r\n<div\r\n\tref=\"elem\"\r\n  :class=\"className\"\r\n  @mouseover.capture=\"$emit('mouseover', $event, index)\"\r\n  @mousedown=\"$emit('mousedown', $event, index)\"\r\n>\r\n  {{ item.label }}\r\n</div>\r\n</template>\r\n\r\n<script>\r\nimport { getItemLabel } from '../helpers/utils';\r\n\r\nexport default {\r\n\tprops: {\r\n\t\tactive: Boolean,\r\n\t\titem: Object,\r\n\t\tindex: Number,\r\n\t},\r\n\tdata: function () {\r\n\t\treturn {\r\n\t\t\tclassName: this.getClassName(),\r\n\t\t\tcontent: getItemLabel(this.item),\r\n\t\t};\r\n\t},\r\n\tmethods: {\r\n\t\tgetClassName: function () {\r\n\t\t\treturn this.active ? \"menu_option menu_option_active\" : \"menu_option\";\r\n\t\t},\r\n\t},\r\n\twatch: {\r\n\t\tactive: function () {\r\n\t\t\tthis.className = this.getClassName();\r\n\r\n\t\t\tif (this.active) {\r\n\t\t\t\tconst { offsetTop, offsetHeight } = this.$refs.elem;\r\n\t\t\t\tthis.$emit('item-activated', offsetTop, offsetHeight);\r\n\t\t\t}\r\n\t\t},\r\n\t},\r\n};\r\n</script>\r\n\r\n<style scoped>\r\n.menu_option {\r\n  background-color: transparent;\r\n  color: inherit;\r\n  cursor: default;\r\n  display: block;\r\n  font-size: inherit;\r\n  width: 100%;\r\n  user-select: none;\r\n  box-sizing: border-box;\r\n  padding: 6px 12px;\r\n}\r\n\r\n.menu_option.menu_option_active {\r\n  background-color: rgb(222, 235, 255);\r\n}\r\n</style>"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$4 = "data-v-6c0e7f99";
	  /* module identifier */
	...
	var __vue_render__$5 = function() {
	  ...
	  var _h = _vm.$createElement;
	  var _c = _vm._self._c || _h;
	  return _c("div", { staticClass: "group_label" }, [
	    _c("span", [
	...
	var script$6 = {
		...
		methods: {
			getClassName: function () {
				var className = "dropdown_container";
	...
	var __vue_render__$6 = function() {
	  ...
	  return _c("div", { class: _vm.classes }, [
	    ...
	    _c(
	      "div",
	      { ref: "contentWrapper", staticClass: "dropdown_content" },
	      [
	          ...
	          return _c(
	            ...
	            [
	              _vm.groups && _vm.groups.hasOwnProperty(idx)
	                ? _c("GroupLabel", { attrs: { data: _vm.groups[idx] } })
	                : _vm._e(),
	              _vm._v(" "),
	              !_vm.itemRenderer
	                ? _c("Item", {
	    ...
	    [
	      ...
	      _c("Input", {
	        ...
	        attrs: {
	          ...
	          customClassName: _vm.customClassName,
	          isMulti: _vm.isMulti,
	      ...
	      _vm.open
	        ? _c("Dropdown", {
	            ...
	            attrs: {
	              className:
	                (_vm.customClassName && _vm.customClassName.dropdown) || "",
	              groups: _vm.groups,
...
//# sourceMappingURL=vue-ahead.min.js.map
