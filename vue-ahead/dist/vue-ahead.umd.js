	...
	var script$3 = {
		...
		methods: {
			...
			getWrapperClassName: function () {
				var wrapperClassName = "vue_ahead__control_wrapper";
	    ...
	    [
	                ...
	                [
	                  _vm.singleSelRenderer && _vm.selection.length === 1
	                    ? _c(_vm.singleSelRenderer, {
	                        tag: "component",
	                        attrs: { selection: _vm.selection[0]["src"] }
	                      })
	      ...
	      _c(
	        ...
	        [
	          ...
	          _vm._v(" "),
	          _c("ControlIcon", {
	            staticClass: "vue_ahead__action_icon",
		...
		methods: {
			...
			handleItemActivated: function (offsetTop, offsetHeight) {
				...
				if (this._moveDelay > 0) {
					this._moveDebounceId = setTimeout(function () {
	...
	var script$7 = {
		...
		methods: {
			...
			handleItemSelection: function (evt, key) {
				...
				this.$emit("selection", {
					type: "add",
					items: this.selection.items.map(function (item) { return item.src; }),
					value: this.value,
				});
